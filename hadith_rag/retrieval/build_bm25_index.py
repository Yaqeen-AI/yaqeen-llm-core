...
def build_bm25_index(
    ...
    """Build and persist the local BM25 sparse index from vector DB documents."""
    ...
    if not doc_ids:
        raise RuntimeError("No documents were loaded from the vector DB; cannot build BM25 index.")
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Build the local BM25 sparse index from vector DB documents.")
