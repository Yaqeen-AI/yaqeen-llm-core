...
from core.config import LM_STUDIO_API_KEY, LM_STUDIO_BASE_URL, LM_STUDIO_MODEL, MAX_OUTPUT_TOKENS
...
def _build_messages(query: str, results: list[Result]) -> list[dict]:
    user_message = (
        f"السؤال: {query}\n\n"
...
def generate_answer_stream(query: str, results: list[Result]):
    """Yield answer tokens as they arrive, appending citation warning at the end if needed."""
